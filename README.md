...
[![Gem Version](https://badge.fury.io/rb/csstats.svg)][rubygems]
[![Build Status](https://travis-ci.org/jpalumickas/csstats.svg?branch=master)][travis]
[![Dependency Status](https://gemnasium.com/jpalumickas/csstats.png?travis)][gemnasium]
[![Coverage Status](https://img.shields.io/coveralls/jpalumickas/csstats.svg?branch=master)][coveralls]
[![Code Climate](https://img.shields.io/codeclimate/github/jpalumickas/csstats.svg)][codeclimate]
